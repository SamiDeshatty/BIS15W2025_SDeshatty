...
homerange %>%
  ggplot(aes(log10.mass))+
  geom_histogram(color="white", fill="lightsalmon")
```
...
homerange %>%
  ggplot(aes(log10.mass))+
  geom_density(fill="pink", color="lightblue", alpha=0.4)
```
...
homerange %>%
  ...
  geom_histogram(color="violet", fill="magenta")
```
...
homerange %>%
  ggplot(aes(log10.hra))+
  geom_density(fill="lavender", color="lightblue", alpha=0.4)
```
...
homerange %>% 
  ...
  geom_histogram(aes(y = after_stat(density)), fill = "pink", alpha = 0.4, color = "black")+
